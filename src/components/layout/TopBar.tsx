  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 shrink-0 md:w-[208px]">
        ...
        {/* Wordmark + environment tag — hidden on very small screens to save header space.
            VITE_APP_TAG is set per-branch in .env so main shows "Beta" and playground
            shows "Playground" without any code change between branches. */}
        <div className="hidden sm:flex flex-col leading-tight">
          <span className="font-semibold text-lg text-white leading-tight">
            Portfolio Pulse
          </span>
          <span className="text-[10px] font-semibold tracking-widest uppercase text-blue-200 leading-none">
