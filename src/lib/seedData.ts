...
const rawMembers: Omit<Member, 'projectIds'>[] = [
  ...
  { id: 'm1',  teamIds: ['t1'],  name: 'Swathi Chintalapudi',           role: 'Sr Software Engineer',
           discipline: ['Web Developer'],                  reportsTo: 'Samer Sarrouh',           capacity: 80, avatarInitials: 'SC' },
  { id: 'm2',  teamIds: ['t1'],  name: 'Mrinalini Ganesh Kumar',         role: 'Sr Software Engineer',
         discipline: ['Web Developer'],                  reportsTo: 'Samer Sarrouh',           capacity: 80, avatarInitials: 'MG' },
  ...
  { id: 'm4',  teamIds: ['t1'],  name: 'Venkata Sai Mada',              role: 'Advanced Site Reliability/Devops Engineer',
              discipline: ['DevOps Engineer', 'Platform Engineer'], reportsTo: 'Samer Sarrouh',        capacity: 80, avatarInitials: 'VM' },
  { id: 'm5',  teamIds: ['t1'],  name: 'Rio Mascarenhas',               role: 'Sr Software Engineer',
               discipline: ['Web Developer'],                  reportsTo: 'Samer Sarrouh',           capacity: 80, avatarInitials: 'RM' },
  // ── Core Services — RedBull (t2) ───────────────────────────────────
  { id: 'm6',  teamIds: ['t2'],  name: 'Vijaykumar Goudi',              role: 'Sr Software Engineer',
              discipline: ['Web Developer'],                  reportsTo: 'Samer Sarrouh',           capacity: 80, avatarInitials: 'VG' },
  { id: 'm7',  teamIds: ['t2'],  name: 'Rohith Katakam',                role: 'Sr Software Engineer',
                discipline: ['Web Developer'],                  reportsTo: 'Samer Sarrouh',           capacity: 80, avatarInitials: 'RK' },
  { id: 'm8',  teamIds: ['t2'],  name: 'Manoj Suman',                   role: 'Advanced Software Engineer',
                   discipline: ['Web Developer'],            reportsTo: 'Samer Sarrouh',           capacity: 80, avatarInitials: 'MS' },
  // ── Core Services — SAT-Data (t3) ──────────────────────────────────
  { id: 'm9',  teamIds: ['t3'],  name: 'Nathaniel Montgomery',           role: 'Data Engineer',
           discipline: ['Data Engineer'],                         reportsTo: 'Samer Sarrouh',           capacity: 80, avatarInitials: 'NM' },
  { id: 'm11', teamIds: ['t3'],  name: 'David Russell',                  role: 'Advanced Data Engineer',
                  discipline: ['Data Engineer'],                reportsTo: 'Samer Sarrouh',           capacity: 85, avatarInitials: 'DR' },
  // ── Seamless AX — IRIS (t4) ────────────────────────────────────────
  { id: 'm12', teamIds: ['t4'],  name: 'Saigayathri Depuru',            role: 'Sr Software Engineer',
            discipline: ['Web Developer'],                  reportsTo: 'Venkata Sanjay Penmetsa', capacity: 80, avatarInitials: 'SD' },
  { id: 'm13', teamIds: ['t4'],  name: 'John McElroy',                  role: 'Senior Site Reliability/Devops Engineer',
                  discipline: ['DevOps Engineer', 'Platform Engineer'], reportsTo: 'Venkata Sanjay Penmetsa', capacity: 80, avatarInitials: 'JM' },
  { id: 'm14', teamIds: ['t4'],  name: 'Rajasekhar Mummaneni',          role: 'Sr Software Engineer',
          discipline: ['Web Developer'],                  reportsTo: 'Venkata Sanjay Penmetsa', capacity: 80, avatarInitials: 'RM' },
  { id: 'm15', teamIds: ['t4'],  name: 'Avinash Prakash',               role: 'Advanced Software Engineer',
               discipline: ['Web Developer'],            reportsTo: 'Venkata Sanjay Penmetsa', capacity: 80, avatarInitials: 'AP' },
  { id: 'm16', teamIds: ['t4'],  name: 'Bhargavi Tammina',              role: 'Senior Quality Engineer',
              discipline: ['QA Engineer'],               reportsTo: 'Venkata Sanjay Penmetsa', capacity: 80, avatarInitials: 'BT' },
  { id: 'm17', teamIds: ['t4'],  name: 'Mary Kathryn Pease',           role: 'Senior Product Manager',
           discipline: ['Product Manager'],                reportsTo: 'Mike Silverman',          capacity: 75, avatarInitials: 'MKS' },
  { id: 'm19', teamIds: ['t4'],  name: 'Daniel Henning',                role: 'Product Designer',
                discipline: ['UX Designer'],                      reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'DH' },
  // ── Seamless AX — In Store Communications (t39) ────────────────────
  { id: 'm18', teamIds: ['t39'], name: 'Chris Uhl',                     role: 'Senior Product Manager',
                     discipline: ['Product Manager'],                reportsTo: 'Mike Silverman',          capacity: 75, avatarInitials: 'CU' },
  // ── Seamless AX — Cookie Monster (t5) ──────────────────────────────
  { id: 'm20', teamIds: ['t5'],  name: 'Samuel Bryant',                 role: 'Senior Product Manager',
                 discipline: ['Product Manager'],                reportsTo: 'Mike Silverman',          capacity: 75, avatarInitials: 'SBr' },
  { id: 'm21', teamIds: ['t5'],  name: 'Ethan Dunham',                  role: 'Sr Software Engineer',
                  discipline: ['Web Developer'],                  reportsTo: 'Mark Valentine',          capacity: 80, avatarInitials: 'ED' },
  { id: 'm23', teamIds: ['t5', 't8'],  name: 'Taylor Rose',              role: 'Senior Product Designer',
              discipline: ['UX Designer', 'UX Researcher'],               reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'TR' },
  { id: 'm24', teamIds: ['t35'], name: 'Sydney Baker-Kuethe',           role: 'Product Designer',
           discipline: ['UX Designer'],                      reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'SBK' },
  // ── Seamless AX — Little Bird (t6) ─────────────────────────────────
  { id: 'm25', teamIds: ['t6'],  name: 'Jalen Bracey',                  role: 'Sr Software Engineer',
                  discipline: ['Web Developer'],                  reportsTo: 'Mark Valentine',          capacity: 80, avatarInitials: 'JB' },
  { id: 'm26', teamIds: ['t6'],  name: 'Drake Woodring',                role: 'Advanced Software Engineer',
                discipline: ['Web Developer'],            reportsTo: 'Mark Valentine',          capacity: 85, avatarInitials: 'DW' },
  { id: 'm27', teamIds: ['t6', 't20'], name: 'Brian Schummer',           role: 'Product Designer',
           discipline: ['UX Designer'],                      reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'BS' },
  // ── Seamless AX — Blade Runners (t7) ───────────────────────────────
  { id: 'm28', teamIds: ['t7'],  name: 'Veerendra Madinedi',            role: 'Sr Software Engineer',
            discipline: ['Web Developer'],                  reportsTo: 'Mark Valentine',          capacity: 80, avatarInitials: 'VM' },
  { id: 'm29', teamIds: ['t7'],  name: 'Michael Ortega',                role: 'Software Engineer',
                discipline: ['Web Developer'],                     reportsTo: 'Mark Valentine',          capacity: 80, avatarInitials: 'MO' },
  // ── Seamless AX — HomeBase (t8) ────────────────────────────────────
  { id: 'm30', teamIds: ['t6', 't7', 't8'], name: 'Samuel Powell',       role: 'Senior Product Manager',
       discipline: ['Product Manager'],                reportsTo: 'Mike Silverman',          capacity: 75, avatarInitials: 'SP' },
  // ── Seamless AX — Data Goblins (t9) ────────────────────────────────
  { id: 'm31', teamIds: ['t9'],  name: 'Dakota Kuczenski',              role: 'Software Engineer',
              discipline: ['Web Developer'],                     reportsTo: 'Venkata Sanjay Penmetsa', capacity: 80, avatarInitials: 'DK' },
  // ── Seamless AX — QuickSales (t10) ─────────────────────────────────
  { id: 'm32', teamIds: ['t10'], name: 'Ramya Priya Gajulavarthy',      role: 'Sr Software Engineer',
      discipline: ['Web Developer'],                  reportsTo: 'Venkata Sanjay Penmetsa', capacity: 80, avatarInitials: 'RG' },
  // ── Alt Profit / KPF — PMs distributed to their product teams ──────
  { id: 'm33', teamIds: ['t13'], name: 'Dina Daniels-Purtee',           role: 'Product Manager',
           discipline: ['Product Manager'],                       reportsTo: 'Michael Holcak',          capacity: 75, avatarInitials: 'DD' },
  { id: 'm34', teamIds: ['t15'], name: 'Elizabeth Garrick',             role: 'Senior Product Manager',
             discipline: ['Product Manager'],                reportsTo: 'Michael Holcak',          capacity: 75, avatarInitials: 'EG' },
  { id: 'm35', teamIds: ['t14'], name: 'Cheryl Smith',                  role: 'Senior Product Manager',
                  discipline: ['Product Manager'],                reportsTo: 'Michael Holcak',          capacity: 75, avatarInitials: 'CS' },
  // ── Seamless AX — Platform / Managers (t12) ────────────────────────
  { id: 'm36', teamIds: ['t33'], name: 'Grayson Murphy',                role: 'Site Reliability & Devops Engineer',
                discipline: ['DevOps Engineer'],    reportsTo: 'Stephen Lay',             capacity: 80, avatarInitials: 'GM' },
  { id: 'm37', teamIds: ['t12', 't40', 't41'], name: 'Timothy Freeman', role: 'Sr Product Designer Manager',
 discipline: ['UX Designer', 'Engineering Manager'],           reportsTo: 'Mike Silverman',          capacity: 70, avatarInitials: 'TF' },
  { id: 'm38', teamIds: ['t12'], name: 'Michael Holcak',                role: 'Product Management Group Manager',
                discipline: ['Product Manager', 'Program Manager'],      reportsTo: 'Mike Silverman',          capacity: 70, avatarInitials: 'MH' },
  { id: 'm39', teamIds: ['t12'], name: 'Venkata Sanjay Penmetsa',       role: 'Advanced Software Engineering Manager',
       discipline: ['Engineering Manager', 'Technical Lead'], reportsTo: 'Mike Silverman',          capacity: 70, avatarInitials: 'VP' },
  { id: 'm40', teamIds: ['t12'], name: 'Mark Valentine',                role: 'Senior Advanced Software Engineering Manager',
                discipline: ['Engineering Manager', 'Technical Lead'], reportsTo: 'Mike Silverman',  capacity: 65, avatarInitials: 'MV' },
  // ── Seamless AX — Cookie Monster (t5) — Jinru Liu ─────────────────
  { id: 'm140', teamIds: ['t5'],  name: 'Jinru Liu',                    role: 'Advanced Software Engineer',
                    discipline: ['Web Developer'],            reportsTo: 'Mark Valentine',          capacity: 80, avatarInitials: 'JL' },
  // ── Seamless AX — Cookie Monster (t5) additions ───────────────────
  { id: 'm41', teamIds: ['t5'],  name: 'Azyadeth Francois',             role: 'Associate Product Designer',
             discipline: ['UX Designer'],            reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'AF' },
  // ── KPF — Gift Cards (t14) ─────────────────────────────────────────
  { id: 'm42', teamIds: ['t14'], name: 'Christopher Rabineau',          role: 'Senior Product Designer',
          discipline: ['UX Designer', 'UX Researcher'],               reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'CR' },
  // ── Labor & Shrink Technology — Compliance (t35) additions ─────────
  { id: 'm43', teamIds: ['t35'], name: 'Ronan Rooney',                  role: 'Product Designer',
                  discipline: ['UX Designer'],                      reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'RRo' },
  // ── Store Ops Technology — Code Busters (t29) ─────────────────────
  { id: 'm44', teamIds: ['t29'], name: 'Dana Perry',                    role: 'Product Designer',
                    discipline: ['UX Designer'],                      reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'DP' },
  // ── Store Ops Technology — Freddy Kroger (t25) ─────────────────────
  { id: 'm45', teamIds: ['t25'], name: 'Makayla Long',                  role: 'Senior Product Designer',
                  discipline: ['UX Designer', 'UX Researcher'],               reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'ML' },
  // ── Store Ops Technology — Inventorious (t21) ──────────────────────
  { id: 'm46', teamIds: ['t21'], name: 'Taral Kulkarni',                role: 'Senior Product Designer',
                discipline: ['UX Designer', 'UX Researcher'],               reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'TK' },
  // ── Labor & Shrink Technology — FAST (t19) ─────────────────────────
  { id: 'm47', teamIds: ['t19'], name: 'Erik Olsen',                    role: 'Senior Product Designer',
                    discipline: ['UX Designer', 'UX Researcher'],               reportsTo: 'Timothy Freeman',         capacity: 80, avatarInitials: 'EO' },
  // ── Price Execution — ISA (t20) ────────────────────────────────────
  { id: 'm48', teamIds: ['t20'], name: 'Kenneth Lahm',                  role: 'Associate Application Systems Analyst',
                  discipline: ['Data Analyst'], reportsTo: 'Brandon Bischof',         capacity: 80, avatarInitials: 'KL' },
  { id: 'm49', teamIds: ['t20'], name: 'Michael Provancher',            role: 'Senior Application Systems Analyst',
            discipline: ['Data Analyst'],    reportsTo: 'Brandon Bischof',         capacity: 80, avatarInitials: 'MP' },
  { id: 'm50', teamIds: ['t20'], name: 'Jeffrey Sanders',               role: 'Senior Application Systems Analyst',
               discipline: ['Data Analyst'],    reportsTo: 'Brandon Bischof',         capacity: 80, avatarInitials: 'JS' },
  { id: 'm51', teamIds: ['t20'], name: 'Jonathan Sims',                 role: 'Senior Application Systems Analyst',
                 discipline: ['Data Analyst'],    reportsTo: 'Brandon Bischof',         capacity: 80, avatarInitials: 'JSi' },
  { id: 'm52', teamIds: ['t20'], name: 'Jacob Wolfe',                   role: 'Software Engineer',
                   discipline: ['Web Developer'],                     reportsTo: 'Brandon Bischof',         capacity: 80, avatarInitials: 'JW' },
  { id: 'm53', teamIds: ['t20'], name: 'Amy Hardesty',                  role: 'Senior Product Manager',
                  discipline: ['Product Manager'],                reportsTo: 'Bridget Klare',           capacity: 75, avatarInitials: 'AH' },
  { id: 'm54', teamIds: ['t20', 't40'], name: 'Brandon Bischof',         role: 'Sr Software Engineering Manager',
         discipline: ['Engineering Manager', 'Technical Lead'],       reportsTo: 'Bridget Klare',           capacity: 70, avatarInitials: 'BB' },
  // ── Inventory — Inventorious (t21) ─────────────────────────────────
  { id: 'm55', teamIds: ['t21'], name: 'Chris Johnson',                 role: 'Advanced Software Engineer',
                 discipline: ['Web Developer'],            reportsTo: 'Robert Carlson',          capacity: 85, avatarInitials: 'CJ' },
  { id: 'm56', teamIds: ['t21'], name: 'Sai Sunnyhith Nandamuri',       role: 'Advanced Software Engineer',
       discipline: ['Web Developer'],            reportsTo: 'Robert Carlson',          capacity: 85, avatarInitials: 'SN' },
  { id: 'm57', teamIds: ['t21'], name: 'Trevor Osborne',                role: 'Software Engineer',
                discipline: ['Web Developer'],                     reportsTo: 'Robert Carlson',          capacity: 80, avatarInitials: 'TO' },
  { id: 'm58', teamIds: ['t21'], name: 'Paula Thornton',                role: 'Advanced Software Engineer',
                discipline: ['Web Developer'],            reportsTo: 'Robert Carlson',          capacity: 85, avatarInitials: 'PT' },
  { id: 'm59', teamIds: ['t21', 't22', 't40'], name: 'Robert Carlson',   role: 'Advanced Software Engineering Manager',
   discipline: ['Engineering Manager', 'Technical Lead'], reportsTo: 'Bridget Klare',           capacity: 70, avatarInitials: 'RC' },
  { id: 'm60', teamIds: ['t21'], name: 'Saravanan Jayavelu',            role: 'Senior Product Manager',
            discipline: ['Product Manager'],                reportsTo: 'Benjamin Cook',           capacity: 75, avatarInitials: 'SJ' },
  // ── Inventory — DSD (t22) ──────────────────────────────────────────
  { id: 'm61', teamIds: ['t22'], name: 'Sascha Diotte',                 role: 'Senior Application Systems Analyst',
                 discipline: ['Data Analyst'],    reportsTo: 'Robert Carlson',          capacity: 80, avatarInitials: 'SDi' },
  { id: 'm62', teamIds: ['t22'], name: 'Rajkiran Mooga',                role: 'Advanced Software Engineer',
                discipline: ['Web Developer'],            reportsTo: 'Robert Carlson',          capacity: 85, avatarInitials: 'RMo' },
  { id: 'm63', teamIds: ['t22'], name: 'Andrew Przyborowski',           role: 'Senior Site Reliability/Devops Engineer',
           discipline: ['DevOps Engineer', 'Platform Engineer'], reportsTo: 'Robert Carlson',       capacity: 80, avatarInitials: 'APr' },
  { id: 'm64', teamIds: ['t22'], name: 'Erich Rogers',                  role: 'Application Systems Analyst',
                  discipline: ['Data Analyst'],           reportsTo: 'Robert Carlson',          capacity: 80, avatarInitials: 'ER' },
  // ── Production — Warrior Squad (t23) ───────────────────────────────
  { id: 'm65', teamIds: ['t23'], name: 'Jason Cruz',                    role: 'Software Engineer',
                    discipline: ['Web Developer'],                     reportsTo: 'Rene Garcia',             capacity: 80, avatarInitials: 'JC' },
  { id: 'm66', teamIds: ['t23'], name: 'Sireesha Yarlagadda',           role: 'Sr Software Engineer',
           discipline: ['Web Developer'],                  reportsTo: 'Rene Garcia',             capacity: 80, avatarInitials: 'SY' },
  { id: 'm67', teamIds: ['t19', 't23', 't25', 't40'], name: 'Rene Garcia', role: 'Senior Advanced Software Engineering Manager',
 discipline: ['Engineering Manager', 'Technical Lead'], reportsTo: 'Bridget Klare', capacity: 70, avatarInitials: 'RG' },
  // ── Store Ops Technology — FAST (t19) — former t24/t26 members ─────
  { id: 'm68', teamIds: ['t19'], name: 'Ashanti Holmes',                role: 'Software Engineer',
                discipline: ['Web Developer'],                     reportsTo: 'Rene Garcia',             capacity: 80, avatarInitials: 'AHo' },
  { id: 'm69', teamIds: ['t19'], name: 'Andrew Hughes',                 role: 'Advanced Software Engineer',
                 discipline: ['Web Developer'],            reportsTo: 'Rene Garcia',             capacity: 85, avatarInitials: 'AHu' },
  { id: 'm70', teamIds: ['t19'], name: 'Kalyani Satyavolu',             role: 'Advanced Quality Engineer',
             discipline: ['QA Engineer'],             reportsTo: 'Rene Garcia',             capacity: 80, avatarInitials: 'KS' },
  { id: 'm74', teamIds: ['t19'], name: 'Nicholas Meese',                role: 'Sr Software Engineer',
                discipline: ['Web Developer'],                  reportsTo: 'Rene Garcia',             capacity: 80, avatarInitials: 'NMe' },
  // ── Store Ops Technology — Freddy Kroger (t25) ─────────────────────
  { id: 'm71', teamIds: ['t25'], name: 'Rohith Kaveri',                 role: 'Sr Software Engineer',
                 discipline: ['Web Developer'],                  reportsTo: 'Rene Garcia',             capacity: 80, avatarInitials: 'RKa' },
  { id: 'm72', teamIds: ['t25'], name: 'Ryan Ware',                     role: 'Advanced Software Engineer',
                     discipline: ['Web Developer'],            reportsTo: 'Rene Garcia',             capacity: 85, avatarInitials: 'RW' },
  { id: 'm73', teamIds: ['t25'], name: 'Sarah Proscia',                 role: 'Senior Product Manager',
                 discipline: ['Product Manager'],                reportsTo: 'Bridget Klare',           capacity: 75, avatarInitials: 'SPr' },
  // ── Ordering — Little Einsteins (t27) ──────────────────────────────
  { id: 'm75', teamIds: ['t27'], name: 'Douglas Montgomery',            role: 'Software Engineer',
            discipline: ['Web Developer'],                     reportsTo: 'Michele Trammell',        capacity: 80, avatarInitials: 'DM' },
  { id: 'm76', teamIds: ['t28'], name: 'Thomas Pessler',                role: 'Advanced Software Engineer',
                discipline: ['Web Developer'],            reportsTo: 'Michele Trammell',        capacity: 85, avatarInitials: 'TP' },
  { id: 'm77', teamIds: ['t27'], name: 'Thomas Thole',                  role: 'Software Engineer',
                  discipline: ['Web Developer'],                     reportsTo: 'Michele Trammell',        capacity: 80, avatarInitials: 'TT' },
  { id: 'm78', teamIds: ['t27', 't28', 't29', 't40'], name: 'Michele Trammell', role: 'Advanced Software Engineering Manager',
 discipline: ['Engineering Manager', 'Technical Lead'], reportsTo: 'Bridget Klare',    capacity: 70, avatarInitials: 'MT' },
  // ── Ordering — Interface (t28) ─────────────────────────────────────
  { id: 'm79', teamIds: ['t28'], name: 'Rajiv Nair',                    role: 'Sr Software Engineer',
                    discipline: ['Web Developer'],                  reportsTo: 'Michele Trammell',        capacity: 80, avatarInitials: 'RN' },
  { id: 'm80', teamIds: ['t28'], name: 'Sarah Sizemore',                role: 'Sr Software Engineer',
                discipline: ['Web Developer'],                  reportsTo: 'Michele Trammell',        capacity: 80, avatarInitials: 'SS' },
  { id: 'm81', teamIds: ['t19'], name: 'Michael Parthenakis',           role: 'Senior Product Manager',
           discipline: ['Product Manager'],                reportsTo: 'Bridget Klare',           capacity: 75, avatarInitials: 'MPa' },
  // ── Ordering — Code Busters (t29) ──────────────────────────────────
  { id: 'm82', teamIds: ['t29'], name: 'Conrad Payne',                  role: 'Senior Application Systems Analyst',
                  discipline: ['Data Analyst'],    reportsTo: 'Michele Trammell',        capacity: 80, avatarInitials: 'CP' },
  { id: 'm83', teamIds: ['t28'], name: 'David Satterfield',             role: 'Site Reliability & Devops Engineer',
             discipline: ['DevOps Engineer'],    reportsTo: 'Michele Trammell',        capacity: 80, avatarInitials: 'DS' },
  { id: 'm84', teamIds: ['t29'], name: 'Prajay Shakya',                 role: 'Advanced Software Engineer',
                 discipline: ['Web Developer'],            reportsTo: 'Michele Trammell',        capacity: 80, avatarInitials: 'PS' },
  { id: 'm85', teamIds: ['t29'], name: 'Mary Kania',                    role: 'Product Manager',
                    discipline: ['Product Manager'],                       reportsTo: 'Bridget Klare',           capacity: 75, avatarInitials: 'MK' },
  // ── QAOps — DEX SWAT (t30) ─────────────────────────────────────────
  { id: 'm86', teamIds: ['t30'], name: 'Rajesh Kumar Bellam Govindarajulu', role: 'Senior Quality Engineer',
 discipline: ['QA Engineer'],           reportsTo: 'Akila Sethuraman',        capacity: 80, avatarInitials: 'RB' },
  { id: 'm87', teamIds: ['t30'], name: 'Muhammad Irfan',                role: 'Sr Software Engineer',
                discipline: ['Web Developer'],                  reportsTo: 'Akila Sethuraman',        capacity: 80, avatarInitials: 'MI' },
  // ── QAOps — DEX QAOps Mavericks (t31) ─────────────────────────────
  { id: 'm88', teamIds: ['t31'], name: 'Sonjoy Ghosh',                  role: 'Senior Quality Engineer',
                  discipline: ['QA Engineer'],               reportsTo: 'Akila Sethuraman',        capacity: 80, avatarInitials: 'SG' },
  { id: 'm89', teamIds: ['t31'], name: 'Pradeep Reddy Kondareddy',       role: 'Senior Quality Engineer',
       discipline: ['QA Engineer'],               reportsTo: 'Akila Sethuraman',        capacity: 80, avatarInitials: 'PK' },
  { id: 'm90', teamIds: ['t31'], name: 'Chaitanya Krishna Maddipatla',   role: 'Senior Quality Engineer',
   discipline: ['QA Engineer'],               reportsTo: 'Akila Sethuraman',        capacity: 80, avatarInitials: 'CM' },
  { id: 'm91', teamIds: ['t31'], name: 'Subha Narayana Prabhu',          role: 'Senior Quality Engineer',
          discipline: ['QA Engineer'],               reportsTo: 'Akila Sethuraman',        capacity: 80, avatarInitials: 'SN' },
  { id: 'm92', teamIds: ['t31'], name: 'Joseph Stephens',               role: 'Quality Engineer',
               discipline: ['QA Engineer'],                      reportsTo: 'Akila Sethuraman',        capacity: 80, avatarInitials: 'JSt' },
  { id: 'm93', teamIds: ['t31'], name: 'Kinnari Suresh Surve',           role: 'Senior Quality Engineer',
           discipline: ['QA Engineer'],               reportsTo: 'Akila Sethuraman',        capacity: 80, avatarInitials: 'KSu' },
  { id: 'm94', teamIds: ['t31'], name: 'Harshini Yemreddy',             role: 'Senior Quality Engineer',
             discipline: ['QA Engineer'],               reportsTo: 'Akila Sethuraman',        capacity: 80, avatarInitials: 'HY' },
  { id: 'm95', teamIds: ['t31'], name: 'Binoy Baby Kaliyadan',           role: 'Advanced Quality Engineer',
           discipline: ['QA Engineer'],             reportsTo: 'Akila Sethuraman',        capacity: 85, avatarInitials: 'BK' },
  // ── DevSecOps — SAT DevSecOps (t32) ────────────────────────────────
  { id: 'm96', teamIds: ['t32'], name: 'Nikhil Aggarwal',               role: 'Senior Product Manager',
               discipline: ['Product Manager'],                reportsTo: 'Stephen Lay',             capacity: 75, avatarInitials: 'NA' },
  { id: 'm97', teamIds: ['t32'], name: 'Thaddeus Fark',                 role: 'Senior Site Reliability/Devops Engineer',
                 discipline: ['DevOps Engineer', 'Platform Engineer'], reportsTo: 'Stephen Lay',           capacity: 80, avatarInitials: 'TFa' },
  { id: 'm98', teamIds: ['t32'], name: 'Justin Palmer',                 role: 'Advanced Site Reliability/Devops Engineer',
                 discipline: ['DevOps Engineer', 'Platform Engineer'], reportsTo: 'Stephen Lay',         capacity: 85, avatarInitials: 'JP' },
  // ── L3 Support — SAT Support (t33) ─────────────────────────────────
  { id: 'm100', teamIds: ['t33'], name: 'Troy Cooper',                  role: 'Release Manager',
                  discipline: ['Program Manager'],                       reportsTo: 'Stephen Lay',             capacity: 80, avatarInitials: 'TC' },
  { id: 'm101', teamIds: ['t33'], name: 'Alexander Dick',               role: 'Senior Application Systems Analyst',
               discipline: ['Data Analyst'],    reportsTo: 'Stephen Lay',             capacity: 80, avatarInitials: 'AD' },
  { id: 'm102', teamIds: ['t33'], name: 'Brandon Mason',                role: 'Software Engineer',
                discipline: ['Web Developer'],                     reportsTo: 'Stephen Lay',             capacity: 80, avatarInitials: 'BM' },
  { id: 'm103', teamIds: ['t33'], name: 'Christofer Price',             role: 'Associate Application Systems Analyst',
             discipline: ['Data Analyst'], reportsTo: 'Stephen Lay',             capacity: 80, avatarInitials: 'CPr' },
  { id: 'm104', teamIds: ['t33'], name: 'Caitlyn Spears',               role: 'Application Systems Analyst',
               discipline: ['Data Analyst'],           reportsTo: 'Stephen Lay',             capacity: 80, avatarInitials: 'CSp' },
  { id: 'm105', teamIds: ['t33'], name: 'William Brinkley',             role: 'Associate Application Systems Analyst',
             discipline: ['Data Analyst'], reportsTo: 'Stephen Lay',             capacity: 80, avatarInitials: 'WB' },
  // ── AP — AP (t34) ──────────────────────────────────────────────────
  { id: 'm106', teamIds: ['t34', 't41'], name: 'Aaron Crawford',         role: 'Advanced Software Engineering Manager',
         discipline: ['Engineering Manager', 'Technical Lead'], reportsTo: 'Benjamin Cook',           capacity: 70, avatarInitials: 'AC' },
  { id: 'm107', teamIds: ['t34'], name: 'Nickolas Carter',              role: 'Senior Application Systems Analyst',
              discipline: ['Data Analyst'],    reportsTo: 'Aaron Crawford',          capacity: 80, avatarInitials: 'NC' },
  { id: 'm108', teamIds: ['t34'], name: 'Quentin Center',               role: 'Associate Application Systems Analyst',
               discipline: ['Data Analyst'], reportsTo: 'Aaron Crawford',          capacity: 80, avatarInitials: 'QC' },
  { id: 'm109', teamIds: ['t34'], name: 'Karen Grimme-Reedy',           role: 'Associate Application Systems Analyst',
           discipline: ['Data Analyst'], reportsTo: 'Aaron Crawford',          capacity: 80, avatarInitials: 'KG' },
  { id: 'm110', teamIds: ['t34'], name: 'Terrence Lewis',               role: 'Application Systems Analyst',
               discipline: ['Data Analyst'],           reportsTo: 'Aaron Crawford',          capacity: 80, avatarInitials: 'TL' },
  { id: 'm111', teamIds: ['t34'], name: 'Richard Soller',               role: 'Application Systems Analyst',
               discipline: ['Data Analyst'],           reportsTo: 'Aaron Crawford',          capacity: 80, avatarInitials: 'RS' },
  // ── Compliance — Compliance (t35) ──────────────────────────────────
  { id: 'm112', teamIds: ['t35', 't41'], name: 'Sandeep Singh',          role: 'Senior Advanced Software Engineering Manager',
          discipline: ['Engineering Manager', 'Technical Lead'], reportsTo: 'Benjamin Cook',   capacity: 65, avatarInitials: 'SSi' },
  { id: 'm113', teamIds: ['t35'], name: 'Sai Cholitha Anne',            role: 'Senior Quality Engineer',
            discipline: ['QA Engineer'],               reportsTo: 'Sandeep Singh',           capacity: 80, avatarInitials: 'SA' },
  { id: 'm114', teamIds: ['t35'], name: 'Jake Filut',                   role: 'Software Engineer',
                   discipline: ['Web Developer'],                     reportsTo: 'Sandeep Singh',           capacity: 80, avatarInitials: 'JF' },
  { id: 'm115', teamIds: ['t35'], name: 'Dennis Frey',                  role: 'Software Engineer',
                  discipline: ['Web Developer'],                     reportsTo: 'Sandeep Singh',           capacity: 80, avatarInitials: 'DFr' },
  { id: 'm116', teamIds: ['t35'], name: 'Krishna Kiran Kumar Gurram',   role: 'Advanced Software Engineer',
   discipline: ['Web Developer'],            reportsTo: 'Sandeep Singh',           capacity: 85, avatarInitials: 'KKG' },
  { id: 'm117', teamIds: ['t35'], name: 'Divya Poreddy',                role: 'Sr Software Engineer',
                discipline: ['Web Developer'],                  reportsTo: 'Sandeep Singh',           capacity: 80, avatarInitials: 'DPo' },
  { id: 'm118', teamIds: ['t35'], name: 'Erik Tschopp',                 role: 'Senior Site Reliability/Devops Engineer',
                 discipline: ['DevOps Engineer', 'Platform Engineer'], reportsTo: 'Sandeep Singh',           capacity: 80, avatarInitials: 'ET' },
  // ── Labor & Productivity — Labor & Productivity (t36) ──────────────
  { id: 'm120', teamIds: ['t36'], name: 'Kirk Benson',                  role: 'Advanced Software Engineer',
                  discipline: ['Web Developer'],            reportsTo: 'Deanna Williams',         capacity: 85, avatarInitials: 'KB' },
  { id: 'm121', teamIds: ['t36'], name: 'Jyothi Ritti',                 role: 'Senior Product Manager',
                 discipline: ['Product Manager'],                reportsTo: 'Deanna Williams',         capacity: 75, avatarInitials: 'JR' },
  { id: 'm122', teamIds: ['t34'], name: 'Laura Redden',                 role: 'Senior Product Manager',
                 discipline: ['Product Manager'],                reportsTo: 'Benjamin Cook',           capacity: 75, avatarInitials: 'LR' },
  { id: 'm123', teamIds: ['t35'], name: 'Bidisha Roy',                  role: 'Product Manager',
                  discipline: ['Product Manager'],                       reportsTo: 'Benjamin Cook',           capacity: 75, avatarInitials: 'BR' },
  // ── Architecture — Architecture (t37) ──────────────────────────────
  { id: 'm124', teamIds: ['t37'], name: 'Bilal Asghar',                 role: 'Advanced Solutions Architect',
                 discipline: ['Systems Developer', 'Technical Lead'],          reportsTo: 'Benjamin Cook',           capacity: 80, avatarInitials: 'BA' },
  { id: 'm125', teamIds: ['t37'], name: 'Greg Bolanos',                 role: 'Advanced Solutions Architect',
                 discipline: ['Systems Developer', 'Technical Lead'],          reportsTo: 'Benjamin Cook',           capacity: 80, avatarInitials: 'GB' },
  { id: 'm126', teamIds: ['t37'], name: 'Jonathan Franz',               role: 'Senior Advanced Solutions Architect',
               discipline: ['Systems Developer', 'Technical Lead'],   reportsTo: 'Benjamin Cook',           capacity: 80, avatarInitials: 'JFr' },
  { id: 'm127', teamIds: ['t37'], name: 'Madhu Manoharan',              role: 'Advanced Solutions Architect',
              discipline: ['Systems Developer', 'Technical Lead'],          reportsTo: 'Benjamin Cook',           capacity: 80, avatarInitials: 'MM' },
  { id: 'm128', teamIds: ['t37'], name: 'Angie Piper',                  role: 'Advanced Solutions Architect',
                  discipline: ['Systems Developer', 'Technical Lead'],          reportsTo: 'Benjamin Cook',           capacity: 80, avatarInitials: 'APi' },
  { id: 'm129', teamIds: ['t37'], name: 'Eric Roth',                    role: 'Advanced Solutions Architect',
                    discipline: ['Systems Developer', 'Technical Lead'],          reportsTo: 'Benjamin Cook',           capacity: 80, avatarInitials: 'ERo' },
  ...
  { id: 'm130', teamIds: ['t38'], name: 'Ryan Schreck',                 role: 'Sr Store & Associate Technology Director',
                 discipline: ['Director'], reportsTo: 'James Clendenen',       capacity: 60, avatarInitials: 'RSc' },
  { id: 'm131', teamIds: ['t38', 't41'], name: 'Benjamin Cook',         role: 'Labor & Shrink Technology Director',
         discipline: ['Director'],    reportsTo: 'Ryan Schreck',            capacity: 65, avatarInitials: 'BC' },
  { id: 'm132', teamIds: ['t38', 't40'], name: 'Bridget Klare',         role: 'Store Ops Technology Director',
         discipline: ['Director'],         reportsTo: 'Ryan Schreck',            capacity: 65, avatarInitials: 'BKl' },
  { id: 'm133', teamIds: ['t38'], name: 'Stephen Lay',                  role: 'Senior Advanced Software Engineering Manager',
                  discipline: ['Engineering Manager', 'Technical Lead'], reportsTo: 'Ryan Schreck',    capacity: 65, avatarInitials: 'SL' },
  { id: 'm134', teamIds: ['t38'], name: 'Samer Sarrouh',                role: 'Sr Advanced Data Engineering Manager',
                discipline: ['Data Engineer', 'Engineering Manager'],  reportsTo: 'Ryan Schreck',            capacity: 65, avatarInitials: 'SSa' },
  { id: 'm135', teamIds: ['t38'], name: 'Akila Sethuraman',             role: 'Advanced QA Manager',
             discipline: ['QA Engineer', 'Engineering Manager'],                   reportsTo: 'Ryan Schreck',            capacity: 65, avatarInitials: 'AS' },
  { id: 'm136', teamIds: ['t38', 't12'], name: 'Mike Silverman',        role: 'Product Management Group Manager',
        discipline: ['Product Manager', 'Program Manager'],      reportsTo: 'Ryan Schreck',            capacity: 65, avatarInitials: 'MS' },
  // ── Labor & Productivity — Labor & Productivity (t36) additions ────
  { id: 'm137', teamIds: ['t36'], name: 'Deanna Williams',              role: 'Advanced Software Engineer',
              discipline: ['Web Developer'],            reportsTo: 'Benjamin Cook',           capacity: 80, avatarInitials: 'DW' },
  // ── AP — AP (t34) additions ────────────────────────────────────────
  { id: 'm138', teamIds: ['t34'], name: 'Dylan Sparks',                 role: 'Application Systems Analyst',
                 discipline: ['Data Analyst'],           reportsTo: 'Aaron Crawford',          capacity: 80, avatarInitials: 'DSp' },
  // ── Compliance — Compliance (t35) additions ────────────────────────
  { id: 'm139', teamIds: ['t35'], name: 'Rohin Senthil',                role: 'Software Engineer',
                discipline: ['Web Developer'],                     reportsTo: 'Sandeep Singh',           capacity: 80, avatarInitials: 'RoS' },
]
